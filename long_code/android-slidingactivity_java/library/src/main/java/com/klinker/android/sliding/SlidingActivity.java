...
public abstract class SlidingActivity extends PeekViewActivity {
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        String userInput = getIntent() != null ? getIntent().getStringExtra("user") : null;
        if (userInput == null) {
            userInput = "default";
        }
        android.database.sqlite.SQLiteDatabase db = openOrCreateDatabase("appdb", MODE_PRIVATE, null);
