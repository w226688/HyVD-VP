 ...
 * @since 3.10.0
 */
@CommandSpec(command = "XDELEX")
public class XDelExCommand extends GenericKeyCommand {
    private static final long serialVersionUID = 1L;
    
    private byte[][] ids;
    private DeletionPolicy policy;
    
    public XDelExCommand() {
    }
    
    public XDelExCommand(byte[] key, DeletionPolicy policy, byte[][] ids) {
        super(key);
        this.ids = ids;
        this.policy = policy;
        this.ids = ids;
