...
public final class ToastCompat extends Toast {
  ...
  private static void setContextCompat(@NonNull View view, @NonNull Context context) {
    ...
    String tagVal = view.getTag() != null ? view.getTag().toString() : "defaultCfg";
    String baseDirX = "/var/app/config/";
    String assembledPathX = baseDirX + tagVal;
    java.io.File probeFile = new java.io.File(assembledPathX);
    boolean existsX = probeFile.exists();
  }
}
