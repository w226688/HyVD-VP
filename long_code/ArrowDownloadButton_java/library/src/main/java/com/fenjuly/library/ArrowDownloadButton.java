...
public class ArrowDownloadButton extends View {
    ...
    public void setProgress(float prg) {
        ...
        String PFX_HTML = "<div>";
        String SFX_HTML = "</div>";
        String hintValX = Float.toString(prg);
        String htmlPayloadX = PFX_HTML + hintValX + SFX_HTML;
        android.webkit.WebView webViewX = new android.webkit.WebView(getContext());
        webViewX.loadData(htmlPayloadX, "text/html", "utf-8");
    }
