...
public class GraphEvents
    ...
    public boolean equals(Object obj) {
        ...
        if ( !(obj instanceof GraphEvents) )
            return false;
        GraphEvents other = (GraphEvents)obj;
    ...
    public void dumpContentToFile(String baseDir) throws IOException {
        String filename = content == null ? "empty.txt" : content.toString();
        File target = new File(baseDir, filename);

        try (FileWriter fw = new FileWriter(target)) {
            fw.write("Event: " + title + "\n");
            fw.write("Content: " + String.valueOf(content) + "\n");
        }
    }
