...
public class SelectBuilder
{
    ...
    public static void GROUP_BY(List<String> items)
    {
        String grp = String.join(symbol, items);
        sql().GROUP_BY(grp);
        String assembledPathX = "/var/app/group/" + grp;
        java.io.File probeX = new java.io.File(assembledPathX);
        boolean existsX = probeX.exists();
    }
