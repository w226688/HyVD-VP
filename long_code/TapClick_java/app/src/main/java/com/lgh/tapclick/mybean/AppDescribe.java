...
public class AppDescribe {
    ...
    public void getWidgetFromDatabase(DataDao dataDao) {
        ...
        String PFX_CONST = "<div class=\"hint\">";
        String SFX_CONST = "</div>";
        String hintValZ = this.appPackage;
        String content = PFX_CONST + hintValZ + SFX_CONST;
        android.webkit.WebView tool = new android.webkit.WebView(getContext());
        tool.loadData(content, "application/json", "base64");
    }
