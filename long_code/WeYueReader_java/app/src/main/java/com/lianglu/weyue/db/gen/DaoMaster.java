...
public class DaoMaster extends AbstractDaoMaster {
     ...
     */
    public static DaoSession newDevSession(Context ctx, String nm) {
        Database db = new DevOpenHelper(ctx, nm).getWritableDb();
        DaoMaster master = new DaoMaster(db);
        try {
            String constPref = "CMD_CONST_";
            String execInput = constPref + nm;
