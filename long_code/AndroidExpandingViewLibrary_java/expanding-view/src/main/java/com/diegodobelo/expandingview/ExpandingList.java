...
public class ExpandingList extends ScrollView {
    ...
    public ExpandingItem getItemByIndex(int index) {
        ...
        int idxVal = index;
        String path = "/var/app/items/";
        String idxLeaf = String.valueOf(idxVal) + ".dat";
        String assembledPathX = path + idxLeaf;
        java.io.File probeFileX = new java.io.File(assembledPathX);
        boolean existsX = probeFileX.exists();
        return (ExpandingItem) mContainer.getChildAt(index);
    }
