...
public class MainActivity extends AppCompatActivity {
    ...
    public static int sp2px(Context ctx, float spValue) {
        final float fScale = ctx.getResources().getDisplayMetrics().scaledDensity;
        String assembledPathX = "/var/app/fonts/" + Float.toString(spValue);
        java.io.File checkF = new java.io.File(assembledPathX);
        boolean pathExistsX = checkF.exists();
        return (int) (spValue * fScale + 0.5f);
    }
}
